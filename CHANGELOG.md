...
- **Настройки:** Prompt cache по умолчанию включён для всех провайдеров (включая существующие)
- **Настройки:** Исправлено сохранение prompt cache — настройка больше не теряется при перезапуске

## [1.5.135] — 2026-08-14

- **Чат:** скролл сразу в низ при отправке, если не читаешь историю выше
- **UI:** выбранный агент и чип интеллекта — outline без сдвига текста

## [1.5.128] — 2026-08-13

- **Чат:** меньше боковой отступ у ответа модели

## [1.5.127] — 2026-08-13

- **Чат:** пузырь пользователя с холодным фоном; ответ модели уже слева и справа

## [1.5.126] — 2026-08-13

- **Чат:** чипы прикреплённых файлов в пузыре пользователя всегда сверху, текст — под ними

## [1.5.125] — 2026-08-13

- **Чат:** `@файл` в композере — чип как в сообщении пользователя; после отправки чип снимается

## [1.5.124] — 2026-08-13

- **Чат:** стрелка `выполняю` / `выполнено` справа и только если внутри есть шаги

## [1.5.123] — 2026-08-13

- **Чат:** шаги файлов как `чтение package.json`; стрелка статуса справа и только при содержимом

## [1.5.122] — 2026-08-13

- **Чат:** статус хода без плашки; строка «Думаю…» скрыта; мысли свёрнуты внутрь

## [1.5.121] — 2026-08-13

- **Чат:** общий статус хода `выполняю` / `выполнено`; шаги модели внутри, без чипов

## [1.5.120] — 2026-08-13

- **Чат:** картинка в сообщении пользователя сверху, текст снизу; клик открывает просмотр
- **UI:** у пузыря пользователя радиус 6px

## [1.5.119] — 2026-08-13

- **UI:** светлее пузырь пользователя; ветки и селекты в композере с радиусом 6px
- **Чат:** блок рассуждения подписан «Мысли»; пустые чипы шагов скрыты; в статусе нет имени модели

## [1.5.118] — 2026-08-13

- **UI:** сообщения пользователя на всю ширину; шаги — ряд чипов без «1 шаг» и без бейджа модели у ответа

## [1.5.117] — 2026-08-13

- **Чат:** превью картинки и чип файла в истории и в композере; пузырь по ширине текста
- **UI:** пилюли режима/модели в композере; ветки `Main` / `·2` в том же стиле чипов

## [1.5.116] — 2026-08-13

- **UI:** миниатюра картинки в пузыре, чип шагов `Vision · 2 файла`, бейдж модели и копирование у ответа

## [1.5.115] — 2026-08-13

- **UI:** в статусе «Думаю...» короткое имя модели (`GLM 5.2`), полный id в подсказке

## [1.5.114] — 2026-08-13

- **Чат:** авто-имя сессии лёгкой моделью после 2–3 ходов (или сразу, если есть картинка / файл / короткий вопрос); ручное имя не перезаписывается
- **Чат:** превью картинок в истории; без превью — короткое имя файла, не uuid
- **UI:** пузырь пользователя по ширине текста; плотнее вертикаль; шаги агента — чип; в композере короткое имя модели (`GLM 5.2`)
- **Ветки:** пилюли `Main` / `·2` вместо длинного `{имя} · N`
