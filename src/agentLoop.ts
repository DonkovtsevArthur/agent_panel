  ...
  const toolsCapabilityHint = [
    ...
    !isReadonlyPolicy(mode.tools)
      ? [
          ...
          "Never say «Готово» / «исправлено» for code edits unless you already called write_file in this turn. After a successful git restore/revert/reset/clean/commit/push, a short Git result is enough.",
